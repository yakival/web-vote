<template>
    <div class="container-fluid">
        <div class="row rowvideo" style="padding: 5px;">
            <div id="cellvideo" class="col-sm-9" style="vertical-align: center;">
                ...
                <div id="cellbuttons" class="col-sm-3" style="vertical-align: center;">
                    <div class="">
                            ...
                            <div id="form-demo">
                                <div class="widget-container">
                                    ...
                                    >
                                        ...
                                        >
                                            <DxSimpleItem data-field="field1" v-if="(settings.fields_json)?((settings.fields_json.field1)?settings.fields_json.field1.active:false):false">
                                                <DxLabel :text="settings.fields_json.field1.name"/>
                                                <DxRequiredRule message="Укажите значение"/>
                                            </DxSimpleItem>
                                            <DxSimpleItem data-field="field2" v-if="(settings.fields_json)?((settings.fields_json.field2)?settings.fields_json.field2.active:false):false">
                                                <DxLabel :text="settings.fields_json.field2.name"/>
                                                <DxRequiredRule message="Укажите значение"/>
                                            </DxSimpleItem>
                                            <DxSimpleItem data-field="field3" v-if="(settings.fields_json)?((settings.fields_json.field3)?settings.fields_json.field3.active:false):false">
                                                <DxLabel :text="settings.fields_json.field3.name"/>
                                                <DxRequiredRule message="Укажите значение"/>
                                            </DxSimpleItem>
                                            <DxSimpleItem data-field="field4" v-if="(settings.fields_json)?((settings.fields_json.field4)?settings.fields_json.field4.active:false):false">
                                                <DxLabel :text="settings.fields_json.field4.name"/>
                                                <DxRequiredRule message="Укажите значение"/>
                                            </DxSimpleItem>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            $("#cellbuttons").removeClass("col-sm-3");
            $("#cellbuttons").addClass("col-sm-12");
            $("#cellvideo").hide();
        ...
        computed: {
            ...
            getURL: function() {
                ...
                if(!this.settings.url_json) return;
                if(this.audio_id === ""){
                    url_ = this.settings.url_json.url;
                }else{
                    url_ = this.settings.url_json["urlch" + this.audio_id];
                }
                if(this.oldURL === ""){
                    if(url_ !== ""){
                        this.oldURL = url_;
                        $("#myFrame").prop('src', "video?url=" + url_);

                        $("#cellbuttons").removeClass("col-sm-12");
                        $("#cellbuttons").addClass("col-sm-3");
                        $("#cellvideo").show();
                    }
                }else{
                    if(url_ !== this.oldURL){
            ...
            async readState_(){
                await axios.get('/api/pult/getdata.asp?clientid=' + this.client_id)
                    .then((resp) => {
                        ...
                        if (!this.settings.authpage) {
                            if(!this.FIO.accept) {
                                if (this.client_id.length > 1) {
                                    this.FIO.field1 = this.client_id;
                                    this.FIO.field2 = "";
                                    this.FIO.field3 = "";
                                    this.FIO.field4 = "";
            ...
            async sendData() {
                ...
                await axios.get('/api/pult/senddata.asp', {
                        params: {
                            ...
                            'fio': this.FIO.field1 +
                                ((this.FIO.field2 !== "")?";"+this.FIO.field2:"") +
                                ((this.FIO.field3 !== "")?";"+this.FIO.field3:"") +
                                ((this.FIO.field4 !== "")?";"+this.FIO.field4:"")
                        }
                    })
                    .then(function (resp) {
                    })
